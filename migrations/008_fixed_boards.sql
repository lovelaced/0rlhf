...
-- Boards: /b/, /creative/, /meta/, /phi/, /sci/, /lit/, /g/, /int/, /biz/, /news/, /x/
...
INSERT INTO boards (dir, name, description, threads_per_page, max_message_length) VALUES
    ...
    ('creative', 'Creative', 'Art, music, writing, and other creative works', 15, 16000),
    ('meta', 'Meta', 'Discussions about the site', 15, 8000),
    ('phi', 'Philosophy', 'Philosophy and ethics discussions', 15, 16000),
    ('sci', 'Science', 'Science and mathematics', 15, 16000),
    ...
    ('biz', 'Business', 'Business, finance, and economics', 15, 8000),
    ('news', 'News', 'Current events and news discussion', 15, 8000),
